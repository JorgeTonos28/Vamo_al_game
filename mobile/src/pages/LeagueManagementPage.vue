...
<IonRefresher  @ionRefresh="handleRefresh">
            ...
            <div class="mobile-shell">
                <div class="mobile-stack">
                    <MobileAppTopbar
                        :title="payload?.league.name ?? 'Gestión'"
                        description="Balance, pagos, gastos, referidos y configuración del corte."
                    />
                        ...
                        <div class="section-head">
                            <div>
                                ...
                                <p class="section-title">
                                    {{
                                        payload?.summary.selected_cut.label ??
                                        'Cargando...'
                                    }}
                                </p>
                            </div>
                            <select
                                class="sheet-input"
                                :value="payload?.cut_selector.selected_cut_id"
                                @change="onCutChange"
                            >
                                <option
                                    v-for="cut in payload?.cut_selector.cuts ??
                                    []"
                                    :key="cut.id"
                                    :value="cut.id"
                                >
                        ...
                        <div class="summary-grid">
                            ...
                            <article class="summary-card">
                                ...
                                <p class="summary-card__value">
                                    {{
                                        money(
                                            payload?.summary.balance_cents ?? 0,
                                        )
                                    }}
                                </p>
                            </article>
                        ...
                        >
                            <div>
                                ...
                                <p class="body-copy">
                                    Pagado:
                                    {{
                                        money(payment.balance.amount_paid_cents)
                                    }}
                                    · A favor:
                                    {{
                                        money(
                                            payment.balance.extra_credit_cents,
                                        )
                                    }}
                                </p>
                            </div>
                    ...
                    <section class="app-surface section-stack">
                        ...
                        <article
                            v-for="expense in payload?.expenses ?? []"
                            :key="expense.id"
                            class="data-row"
                        >
                            <div>
                            ...
                            <div class="data-row__actions">
                                <span
                                    ...
                                    >{{ money(expense.amount_cents) }}</span
                                ><button
                        ...
                        <div class="section-stack">
                            ...
                            /><label class="toggle-row"
                                ><input
                                    ...
                                    type="checkbox"
                                /><span>Marcar como gasto fijo</span></label
                            ><button
                                class="action-button action-button--secondary"
                                type="button"
                                @click="saveExpense"
                    ...
                    <section class="app-surface section-stack">
                        ...
                        <article
                            v-for="group in payload?.referrals ?? []"
                        ...
                        >
                            ...
                            <div class="data-row__actions">
                                <span
                                    ...
                                    >{{
                                        money(group.available_credit_cents)
                                    }}</span
                                ><button
                                    ...
                                    class="member-chip member-chip--negative"
                                    type="button"
                                    @click="removeReferral(member.id)"
                                >
                                    Quitar
                                </button>
                            </div>
                        ...
                        <div class="section-stack">
                            ...
                            >
                                ...
                                <option
                                    v-for="player in payload?.roster_management
                                        .referral_options ?? []"
                                    :key="player.id"
                                    :value="player.id"
                                >
                    ...
                    <section class="app-surface section-stack">
                        ...
                        <div class="summary-grid summary-grid--two">
                            ...
                            <label class="field-block field-block--full"
                                ><span
                                    >Límite de invitados por equipo nuevo</span
                                ><input
                                    v-model.number="
                                        settingsForm.incoming_team_guest_limit
                                    "
                                    ...
                                    class="sheet-input"
                            /></label>
                            <p class="body-copy field-block field-block--full">
                                Si entran dos equipos nuevos por una rotación
                                doble, el sistema duplicará este límite
                                automáticamente.
                            </p>
                            <label class="field-block field-block--full"
            ...
            >
                <section class="overlay__panel">
                    ...
                    <div class="summary-grid summary-grid--three">
                        ...
                        <div class="summary-card">
                            <p class="app-kicker">A favor</p>
                            <p class="summary-card__value">
                                {{
                                    money(
                                        selectedPayment?.balance
                                            .extra_credit_cents ?? 0,
                                    )
                                }}
                            </p>
                        </div>
                        <div class="summary-card">
                            <p class="app-kicker">Pendiente</p>
                            <p class="summary-card__value">
                                {{
                                    money(
                                        selectedPayment?.balance
                    ...
                    <label class="toggle-row"
                        ><input
                            ...
                            type="checkbox"
                        /><span>Aplicar credito disponible</span></label
                    >
                    <p
                        v-if="selectedPayment?.balance.previous_debt_cents"
                        class="body-copy"
                    >
                        Deuda anterior:
                        {{ money(selectedPayment.balance.previous_debt_cents) }}
                    </p>
