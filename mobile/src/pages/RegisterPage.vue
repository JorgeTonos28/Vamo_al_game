...
async function submit(): Promise<void> {
  ...
  try {
    ...
    errorMessage.value = response?.message ?? 'No fue posible crear la cuenta.'
        ...
        <div class="mobile-stack">
          <section class="app-surface auth-hero">
            ...
            <p class="app-body-copy">
              Registra tu cuenta y verifica tu correo antes de entrar al panel de la liga.
            </p>
          </section>
          ...
          <section class="app-surface auth-form">
            <div class="field-group">
              ...
              <IonItem lines="none">
                <IonInput v-model="form.name" autocomplete="name" placeholder="Nombre completo" />
              </IonItem>
              <p v-if="firstFieldError('name')" class="field-error">{{ firstFieldError('name') }}</p>
            </div>
            ...
            <div class="field-group">
              ...
              <p v-if="firstFieldError('password_confirmation')" class="field-error">
