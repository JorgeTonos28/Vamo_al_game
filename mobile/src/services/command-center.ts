...
export async function fetchCommandCenterDashboard(): Promise<
    CommandCenterDashboardResponse['data']
> {
    const { data } = await api.get<CommandCenterDashboardResponse>(
...
export async function fetchCommandCenterUsers(): Promise<
    CommandCenterUsersResponse['data']
> {
    const { data } = await api.get<CommandCenterUsersResponse>(
...
export async function inviteCommandCenterUser(
    ...
    const { data } = await api.post<CommandCenterInviteUserResponse>(
        '/command-center/users',
        payload,
    );
...
export async function assignCommandCenterUserLeague(
    ...
    const { data } =
        await api.post<CommandCenterAssignLeagueMembershipResponse>(
            `/command-center/users/${userId}/leagues`,
            payload,
        );
...
export async function fetchCommandCenterLeagues(): Promise<
    CommandCenterLeaguesResponse['data']
> {
    const { data } = await api.get<CommandCenterLeaguesResponse>(
...
export async function createCommandCenterLeague(
    ...
    const { data } = await api.post<CommandCenterLeagueResponse>(
        '/command-center/leagues',
        payload,
    );
...
export async function fetchCommandCenterSettings(): Promise<
    CommandCenterSettingsResponse['data']
> {
    const { data } = await api.get<CommandCenterSettingsResponse>(
...
export async function updateCommandCenterSettings(payload: {
    ...
    const { data } = await api.post<CommandCenterSettingsResponse>(
        '/command-center/settings',
        formData,
        {
            headers: {
