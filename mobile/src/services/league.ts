...
export async function fetchLeagueHome(): Promise<LeagueHomePayload> {
    const { data } =
        await api.get<ApiSuccess<LeagueHomePayload>>('/league/home');
...
export async function fetchLeagueArrival(): Promise<LeagueArrivalPayload> {
    const { data } =
        await api.get<ApiSuccess<LeagueArrivalPayload>>('/league/arrival');

    return data.data;
}

export async function toggleLeagueArrivalPlayer(
    playerId: number,
    paid?: boolean,
): Promise<LeagueArrivalPayload> {
    const { data } = await api.post<ApiSuccess<LeagueArrivalPayload>>(
        `/league/arrival/players/${playerId}/toggle`,
        {
            paid,
        },
    );
...
export async function addLeagueArrivalGuest(
    guestName: string,
): Promise<LeagueArrivalPayload> {
    const { data } = await api.post<ApiSuccess<LeagueArrivalPayload>>(
...
export async function updateLeagueArrivalGuest(
    guestId: number,
    guestFeePaid: boolean,
): Promise<LeagueArrivalPayload> {
    const { data } = await api.patch<ApiSuccess<LeagueArrivalPayload>>(
        `/league/arrival/guests/${guestId}`,
        {
...
export async function deleteLeagueArrivalGuest(
    guestId: number,
): Promise<LeagueArrivalPayload> {
    const { data } = await api.delete<ApiSuccess<LeagueArrivalPayload>>(
        `/league/arrival/guests/${guestId}`,
    );
...
export async function prepareLeagueArrival(
    guestPayments: Array<{ id: number; paid: boolean }>,
): Promise<LeagueArrivalPayload> {
    const { data } = await api.post<ApiSuccess<LeagueArrivalPayload>>(
...
export async function fetchLeagueManagement(
    cutId?: number,
): Promise<LeagueManagementPayload> {
    const { data } = await api.get<ApiSuccess<LeagueManagementPayload>>(
        '/league/management',
        {
...
export async function recordLeaguePayment(
    playerId: number,
    payload: {
        cut_id: number;
        amount_cents: number;
    ...
    const { data } = await api.post<ApiSuccess<LeagueManagementPayload>>(
        `/league/management/payments/${playerId}`,
        payload,
    );
...
export async function removeLeaguePayment(
    playerId: number,
    cutId: number,
): Promise<LeagueManagementPayload> {
    const { data } = await api.delete<ApiSuccess<LeagueManagementPayload>>(
        `/league/management/payments/${playerId}`,
        {
            data: { cut_id: cutId },
        },
...
export async function addLeagueExpense(payload: {
    cut_id: number;
    name: string;
    amount_cents: number;
    is_fixed?: boolean;
...
export async function deleteLeagueExpense(
    expenseId: number,
): Promise<LeagueManagementPayload> {
    const { data } = await api.delete<ApiSuccess<LeagueManagementPayload>>(
        `/league/management/expenses/${expenseId}`,
    );
...
export async function addLeagueReferral(payload: {
...
export async function deleteLeagueReferral(
    referralId: number,
): Promise<LeagueManagementPayload> {
    const { data } = await api.delete<ApiSuccess<LeagueManagementPayload>>(
        `/league/management/referrals/${referralId}`,
    );
...
export async function updateLeaguePlayer(
    ...
    const { data } = await api.patch<ApiSuccess<LeagueManagementPayload>>(
        `/league/management/players/${playerId}`,
        payload,
    );
...
export async function setLeaguePlayerStatus(
    ...
    const { data } = await api.patch<ApiSuccess<LeagueManagementPayload>>(
        `/league/management/players/${playerId}/status`,
        {
            active,
        },
    );
...
export async function downloadLeagueManagementReport(
    cutId: number,
): Promise<string> {
...
export async function fetchLeagueQueue(
    sessionId?: number,
): Promise<LeagueQueuePayload> {
    const { data } = await api.get<ApiSuccess<LeagueQueuePayload>>(
...
export async function fetchLeagueStats(
    ...
    const { data } = await api.get<ApiSuccess<LeagueStatsPayload>>(
...
export async function fetchLeagueSeason(): Promise<LeagueSeasonPayload> {
    const { data } = await api.get<ApiSuccess<LeagueSeasonPayload>>(
...
export async function fetchLeagueScout(): Promise<LeagueScoutPayload> {
    const { data } = await api.get<ApiSuccess<LeagueScoutPayload>>(
...
export async function addLeagueTeamPoint(
    teamSide: 'A' | 'B',
): Promise<LeagueGamePayload> {
    const { data } = await api.post<ApiSuccess<LeagueGamePayload>>(
...
export async function addLeaguePlayerPoint(
    entryId: number,
    points: 1 | 2 | 3,
): Promise<LeagueGamePayload> {
    const { data } = await api.post<ApiSuccess<LeagueGamePayload>>(
        `/league/modules/game/players/${entryId}/point`,
        {
            points,
        },
    );
...
export async function revertLeaguePlayerPoint(
    entryId: number,
    points: 1 | 2 | 3,
): Promise<LeagueGamePayload> {
    const { data } = await api.post<ApiSuccess<LeagueGamePayload>>(
        `/league/modules/game/players/${entryId}/revert`,
        {
            points,
        },
    );
...
export async function finishLeagueGame(
    winnerSide?: 'A' | 'B',
): Promise<LeagueGamePayload> {
    const { data } = await api.post<ApiSuccess<LeagueGamePayload>>(
...
export async function configureLeagueGameClock(
...
export async function updateLeagueScoutPlayer(
    ...
    const { data } = await api.patch<ApiSuccess<LeagueScoutPayload>>(
        `/league/modules/scout/players/${playerId}`,
        payload,
    );
